...
import com.example.navdrawer.fragments.MakananFavFragment;
import com.example.navdrawer.fragments.MakananKhasFragment;
import com.example.navdrawer.fragments.MinumanKhasFragment;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.menu_item1) {
                    ...
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.content_frame, new MakananFavFragment())
                            .commit();
